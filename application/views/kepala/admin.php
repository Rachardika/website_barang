    ...
    <div class=" container-fluid" style="padding-top: 0px">
      ...
      <div class="card mb-3 shadow">
        <div class="card-header" style="letter-spacing:1px;">
          <h3><i class="fas fa-table"></i> Tabel Pegawai
            <a href="<?= base_url('kepala/addAdmin'); ?>" class="btn btn-primary btn-md float-right"><i class="fas fa-plus"></i> Tambah Data</a>
          </h3>
        </div>
        <div class="card-body">
...
<script>
  $(document).ready(function() {
    $('#tabel_member').DataTable({
      ...
      "serverSide": true,
      "ajax": {
        "url": "<?= base_url('kepala/get_ajax_admin') ?>",
        "type": "POST"
      },
      "columnDefs": [{
        "targets": [3],
