        ...
        <div class=" container-fluid" style="padding-top: 0px">
            ...
            <div class="card mb-3 shadow">
                <div class="card-header" style="letter-spacing:1px;">
                    <h3><i class="fas fa-table"></i> Tabel Item
                        <a href="<?= base_url('kepala/addItem'); ?>" class="btn btn-primary btn-md float-right"><i class="fas fa-plus"></i> Tambah Data</a>
                    </h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center" id="tabel_item" width="100%" cellspacing="0">
                            <!-- edited table-->
...
<script>
    $(document).ready(function() {
        $('#tabel_item').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('kepala/get_ajax_item') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [3],
