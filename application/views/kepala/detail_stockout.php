      ...
      <div class=" container-fluid" style="padding-top: 0px">
          ...
          <div class="col-md-10" style="display: block; margin-left:auto; margin-right:auto">
              <div class="card mb-3 shadow">
                  ...
                  <div class="card-body">
                      <div class="container">
                          <form action="<?= base_url('kepala/editStockout/'); ?><?= $stock['stockout_id'] ?>" method="POST" enctype="multipart/form-data">
                              <?= $this->session->flashdata('message'); ?>
                              <div class="container">
                                  <br>

                                  <?= form_open_multipart('kepala/editStockout'); ?>
                                  ...
                                  <div class="form-group row justify-content-center">
                                      <label for="nama" class="col-sm-2 col-form-label"><strong>Tanggal Keluar </strong></label>
                                      <div class="col-sm-4 ">
                                          <label for="nama" class="col-form-label">: <?= $stock['tanggal']; ?>, <?= $stock['jam']; ?></label>
                                      </div>
                                  </div>
                                  <div class="form-group row justify-content-center">
                                      <label for="penerima" class="col-sm-2 col-form-label"><strong>Diinput Oleh </strong></label>
                                      <div class="col-sm-4 ">
                                          <label for="penerima" class="col-form-label">: <?= $stock['penerima'];; ?></label>
                                      </div>
                                  </div>
                                  <hr>
                                  ...
                                  <div class="form-group row justify-content-end">
                                      <div class="col-sm-0">
                                          <a href="<?= base_url('kepala/stockOut'); ?>">
