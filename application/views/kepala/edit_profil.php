...
<div class="content-wrapper">
  ...
  <div class=" container-fluid" style="padding-top: 0px">
    ...
    <ol class="breadcrumb shadow" style="background-color:#fff;">
      ...
      <li class="breadcrumb-item">
        <a href="<?= base_url("kepala/") ?>profil">Profil</a>
      </li>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12" style="display: block; margin-left:auto; margin-right:auto">
                <?= form_open_multipart('kepala/editProfil'); ?>
                <div class="form-group row">
                  <label for="no_identitas" class="col-sm-2 col-form-label">NIP</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_identitas" name="no_identitas" value="<?= $user['nip']; ?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="jenkel" name="jenkel" value="<?= $user['jenkel']; ?>" readonly>
