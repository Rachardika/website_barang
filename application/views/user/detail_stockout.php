      ...
      <div class=" container-fluid" style="padding-top: 0px">
          ...
          <div class="col-md-10" style="display: block; margin-left:auto; margin-right:auto">
              <div class="card mb-3 shadow">
                  ...
                  <div class="card-body">
                      <div class="container">
                          <form action="<?= base_url('user/editStockout/'); ?><?= $stock['stockout_id'] ?>" method="POST" enctype="multipart/form-data">
                              <?= $this->session->flashdata('message'); ?>
                              <div class="container">
                                  <br>

                                  <?= form_open_multipart('user/editStockout'); ?>
