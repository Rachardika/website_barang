...
{
	// start datatables
	var $column_order = array(null, 'nama', 'keterangan', 'tanggal', 'file'); //set column field database for datatable orderable
	var $column_search = array('nama', 'keterangan'); //set column field database for datatable searchable
